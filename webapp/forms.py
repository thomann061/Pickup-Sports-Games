...
class GameForm(forms.Form):
    gameName = forms.CharField(widget=forms.TextInput(attrs={'class' : 'form-control form-box'}), label="Name", max_length=50)
    gameType = forms.CharField(widget=forms.TextInput(attrs={'class' : 'form-control form-box'}), label="Type", max_length=50)
    gameLocation = forms.CharField(widget=forms.TextInput(attrs={'class' : 'form-control form-box'}), label="Location", max_length=50)
